...
-(IBAction)pop3Clicked {
    Pop3ConfigViewController* vc = [[Pop3ConfigViewController alloc] initWithNibName:@"Pop3Config" bundle:nil];
    vc.firstSetup = self.firstSetup;
    vc.accountNum = self.accountNum;
    vc.newAccount = self.newAccount;
    vc.title = NSLocalizedString(@"POP3", nil);
    [self.navigationController pushViewController:vc animated:YES];
    [vc release];
