...
#import "Pop3ConfigViewController.h"
...
#import "libetpan/pop3driver_types.h"

@implementation Pop3ConfigViewController
...
-(void)doLogin:(NSNumber*)forceSelectFolders {
    ...
    NSString* response = [Pop3Sync validate:username password:password server:server port:port encryption:encryption authentication:authentication folders:folderNames];
